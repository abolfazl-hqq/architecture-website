        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-48 pb-12">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="w-10 h-10 bg-surface-100 text-slate-700 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-primary-100"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-surface-100 text-slate-700 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-accent-100"
                  aria-label="لینکدین"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-surface-100 text-slate-700 rounded-lg flex items-center justify-center transition-all duration-300 hover:scale-110 hover:bg-success-100"
                  aria-label="تلگرام"
                >
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div id='contact'>
              ...
              <ul className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <p className="text-slate-600 font-medium">مشهد، شهرک غرب</p>
                  </div>
                </li>
                <li className="flex items-center gap-3">
                  <span className="text-2xl">📞</span>
                  <div>
                    <p className="text-slate-600 font-medium">021-12345678</p>
                    <p className="text-slate-500 text-sm font-medium">0911-1234567</p>
                  </div>
                </li>
                <li className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="text-slate-600 font-medium">
                      <a href="mailto:info@navasan.com" className="hover:text-primary-600 transition-colors duration-300">
                        info@navasan.com
                      </a>
                    </p>
                  </div>
                ...
                <li className="flex items-center gap-3">
                  <span className="text-2xl">🕐</span>
                  <div>
                    <p className="text-slate-600 font-medium">شنبه تا چهارشنبه</p>
                    <p className="text-slate-500 text-sm font-medium">9:00 - 17:00</p>
                  </div>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <p className="text-slate-600 mb-4">
                برای دریافت آخرین خبرها و پروژه‌های ما، ایمیل خود را وارد کنید.
              </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-slate-500 text-sm">
              ...
              <a href="https://example.com" target="_blank" rel="noopener noreferrer" className="text-primary-600 font-medium hover:text-primary-700 transition-colors duration-300">
                طراح وب
              </a>
            </p>
